...
def message_on_failure(context: HookContext):
    ...
    send_mail_new(message,subject=f'Ошибка {context.job_name}',to_emails='petryakov.v@gmail.com')
...
airbyte_assets = load_assets_from_airbyte_instance(airbyte_instance, key_prefix=["analytics"])
